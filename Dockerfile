...
RUN apt-get update && apt-get install software-properties-common python-software-properties -y && add-apt-repository ppa:openjdk-r/ppa && apt-get update && apt-get install -yq openjdk-7-jre
